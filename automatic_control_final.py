...
class World(object):
    ...
    def restart(self, args, spawn_pt=None):
        """Restart the world"""
...
def game_loop(args):
    ...
    try:
        ...
        for index in range(edge_table.shape[0]):
            ...
            spawn_loc = carla.Location(x=map_obj.node_dict["location"]["x"][spawn_index],
                                       y=map_obj.node_dict["location"]["y"][spawn_index],
                                       z=map_obj.node_dict["location"]["z"][spawn_index])
            spawn_rot = carla.Rotation(roll=map_obj.node_dict["rotation"]["roll"][spawn_index],
